...
import RoadDiorama from "@/components/RoadDiorama";
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-8 px-6 py-12 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:py-16">
          ...
          <div className="mx-auto grid w-full max-w-4xl gap-3 sm:grid-cols-3 lg:col-span-2 lg:mt-2">
            {[
              ...
              <div key={label} className="border-t border-white/25 py-5 text-left sm:text-center">
      ...
      <section id="masalah" className="bg-gradient-to-b from-cream via-white to-sky-50/50 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2">
            <article className="group border-t-4 border-amber-400 bg-amber-50/40 px-1 py-8 sm:p-9">
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="relative mt-14 grid gap-4 lg:grid-cols-12">
            {impacts.map((impact, index) => {
              ...
              return (
                <SpotlightCard key={impact.title} spotlightColor={index === 3 ? "rgba(255,255,255,.22)" : "rgba(142,216,255,.18)"} className={`${layouts[index]} ${surfaces[index]} group relative min-h-64 rounded-3xl border border-white/10 p-7 shadow-lg shadow-black/5 sm:p-9`}>
